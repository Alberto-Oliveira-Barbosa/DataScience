...
- [**Python** -> Exercícios com bibliotecas para data science com pyhton](https://github.com/Alberto-Oliveira-Barbosa/DataScience/tree/master/python)
- [**scripts_automatizados** -> Script que faz uma análise básica de um dataset](https://github.com/Alberto-Oliveira-Barbosa/DataScience/tree/master/scripts_automatizados)


## Cursos

- [**Introdução ao Keras**-> Introdução a deep learning com keras](https://github.com/Alberto-Oliveira-Barbosa/introducao-keras/blob/master/classificacao_roupas.ipynb)
- [**Recomendação de Filmes**-> Estudos em aprendizagem não supervisionada para a geração de clusters e recomendação de filmes](https://github.com/Alberto-Oliveira-Barbosa/recomendacao-de-filmes/blob/master/recomendacao_de_filmes.ipynb)
- [**Introdução a Machine Learning com Sklearn**-> Introdução a classificação e algoritmos supervisionados](https://github.com/Alberto-Oliveira-Barbosa/curso-machine-learning)
